...
Public Class frmSales
    ...
    Private Sub txtCancel_Click(sender As Object, e As EventArgs)
        'SalesBindingNavigator.AddNewItem.PerformClick()
        'txtTotal.Text = 0
        'txtVAT.Text = 0
        'txtCash.Text = ""
    ...
    Private Sub CheckBox1_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckBox1.CheckedChanged
        If CheckBox1.Checked = True Then
            txtVAT.Text = Val(Totals) * 0.05
            txtTotal.Text = Val(Totals) - Val(txtVAT.Text)
            txtKHR.Text = txtTotal.Text * 4100
            discount = txtVAT.Text.Replace(",", "")
            Format(discount, "#,##0.00")
        Else
            txtVAT.Text = "0.00"
            txtTotal.Text = Val(Totals)
            txtKHR.Text = Val(Totals) * 4100
            discount = txtVAT.Text.Replace(",", "")
            Format(discount, "#,##0.00")
        End If
